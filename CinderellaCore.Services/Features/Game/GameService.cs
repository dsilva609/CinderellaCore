...
namespace CinderellaCore.Services.Features.Game
{
    public class GameService : IGameService
    {
        ...
        private readonly IRepository<Model.Models.Game> _repository;
        ...
        public GameService(IUnitOfWork uow, ApplicationUser user)
        {
            _user = user;
            _repository = uow.GetRepository<Model.Models.Game>();
        ...
        public void Add(Model.Models.Game game)
        {
        ...
        public List<Model.Models.Game> GetAll(string userID = "", string query = "", int numToTake = 0, int? pageNum = 1)
        {
            ...
            {
                var currentList = new List<Model.Models.Game>();
        ...
        public Model.Models.Game GetByID(int id, string userID) => _getEntityByIDComponent.Execute(_repository, id, userID);

        public void Edit(Model.Models.Game game) => _editEntityComponent.Execute(_repository, game);
