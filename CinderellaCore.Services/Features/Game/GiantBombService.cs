...
namespace CinderellaCore.Services.Features.Game
{
    public class GiantBombService : IGiantBombService
    {
        ...
        public GiantBombService(GlobalSettings settings)
        {
            _settings = settings;
            CreateHttpClient();
        }
        ...
        public Model.Models.Game SearchByID(int id)
        {
        ...
        private Model.Models.Game ConvertGiantBombGameToGame(GiantBombGame result)
        {
            var game = new Model.Models.Game();
