...
namespace CinderellaCore.Services.Features.Book
{
    public class GoogleBookService : IGoogleBookService
    {
        ...
        public List<Model.Models.Book> Search(string author, string title)
        {
            ...
            var books = new List<Model.Models.Book>();
        ...
        public Model.Models.Book SearchByID(string id)
        {
        ...
        private Model.Models.Book ConvertVolumeToBook(Volume volume, bool fromSearch)
        {
