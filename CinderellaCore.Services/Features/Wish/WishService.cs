...
namespace CinderellaCore.Services.Features.Wish
{
    public class WishService : IWishService
    {
        ...
        private readonly IRepository<Model.Models.Wish> _repository;
        ...
        {
            _user = user;
            _repository = uow.GetRepository<Model.Models.Wish>();
        ...
        public void Add(Model.Models.Wish wish)
        {
        ...
        public List<Model.Models.Wish> GetAll(string userID = "", string query = "", int numToTake = 0, int? pageNum = 1)
        {
            ...
            {
                var currentList = new List<Model.Models.Wish>();
        ...
        public Model.Models.Wish GetByID(int id, string userID) => _getEntityByIDComponent.Execute(_repository, id, userID);

        public void Edit(Model.Models.Wish wish) => _editEntityComponent.Execute(_repository, wish);
