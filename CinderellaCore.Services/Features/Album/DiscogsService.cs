...
namespace CinderellaCore.Services.Features.Album
{
    public class DiscogsService : IDiscogsService
    {
        ...
        public async Task<Model.Models.Album> GetRelease(int releaseID)
        {
        ...
        private Model.Models.Album ConvertFromRelease(DiscogsRelease release)
        {
            var album = new Model.Models.Album
            {
